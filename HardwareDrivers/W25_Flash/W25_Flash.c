...
#define W25_ReadStatusReg		    0x05
#define W25_WriteStatusReg		    0x01
...
uint8_t SPI_FLASH_Init(void)
{
  ...
  /* Enable SPI_FLASH_SPI and GPIO clocks */
...
void SPI_FLASH_SectorErase(u32 SectorAddr)
{
  ...
  SPI_FLASH_SendByte(W25_SectorErase);
...
void SPI_FLASH_BulkErase(void)
{
  ...
  SPI_FLASH_SendByte(W25_ChipErase);
  /* Deselect the FLASH: Chip Select high */
  SPI_FLASH_CS_HIGH();
...
void SPI_FLASH_PageWrite(u8* pBuffer, u32 WriteAddr, u16 NumByteToWrite)
{
  ...
  SPI_FLASH_SendByte(W25_PageProgram);
...
uint8_t SPI_FLASH_BufferRead(u8* pBuffer, u32 ReadAddr, u16 NumByteToRead)
{
  ...
  SPI_FLASH_SendByte(W25_ReadData);
...
u32 SPI_FLASH_ReadID(void)
{
  ...
  SPI_FLASH_SendByte(W25_JedecDeviceID);
...
u32 SPI_FLASH_ReadDeviceID(void)
{
  ...
  /* Send "RDID " instruction */
  SPI_FLASH_SendByte(W25_DeviceID);
...
u8 SPI_FLASH_SendByte(u8 byte)
{
  ...
  /* Send byte through the SPI_FLASH_SPI peripheral */
...
u16 SPI_FLASH_SendHalfWord(u16 HalfWord)
{
  ...
  /* Send Half Word through the SPI_FLASH_SPI peripheral */
...
void SPI_FLASH_WriteEnable(void)
{
  ...
  /* Send "Write Enable" instruction */
  SPI_FLASH_SendByte(W25_WriteEnable);
...
void SPI_FLASH_WaitForWriteEnd(void)
{
  ...
  SPI_FLASH_SendByte(W25_ReadStatusReg);
...
void SPI_Flash_PowerDown(void)
{
  ...
  SPI_FLASH_SendByte(W25_PowerDown);
...
void SPI_Flash_WAKEUP(void)
{
  ...
  /* Send "Power Down" instruction */
  SPI_FLASH_SendByte(W25_ReleasePowerDown);
